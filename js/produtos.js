...
/* ==========================================
   QA STORES
   produtos.js
   Parte 2 - Pesquisa, Filtros e Ordenação
========================================== */
...
function pesquisar(){
    ...
    /*
        ...
        Não utiliza toLowerCase().
        A busca diferencia maiúsculas
        de minúsculas.
    */
    ...
    const resultado=produtos.filter(function(produto){
        ...
        /*
            ...
            Pesquisa somente pelo nome.
            Não pesquisa categoria
            nem descrição.
        */
